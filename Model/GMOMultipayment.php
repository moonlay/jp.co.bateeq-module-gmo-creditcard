...
namespace Moonlay\GMOMultiPayment\Model;

use Moonlay\GMOMultiPayment\Helper\Crypto;
use Magento\Payment\Gateway\Response\HandlerInterface;
use Magento\Framework\Exception\LocalizedException;

class GMOMultipayment extends \Magento\Payment\Model\Method\AbstractMethod implements HandlerInterface
{
	...
	public function handle(array $handlingSubject, array $response)
	{
		...
		if ($parsed_header['response_code'] == '204') {
			...
			$error_message = 'GMO Multipayment refunding error: Failed Signature Check when communicating with the GMO gateway.';
			...
			$error_message = 'GMO Multipayment refunding error with returned message from gateway: '.$return_message.$return_message_explain;
		} else {
			$error_message = "GMO Multipayment refunding failed with unknown error.";
		}
